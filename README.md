...
| ng_directive_name | All your directives should have a name starting the parameter you can define in your config object. The second parameter can be a Regexp. ("ng_directive_name":  [2, "ng"]) [Y073](https://github.com/johnpapa/angularjs-styleguide#style-y073), [Y126](https://github.com/johnpapa/angularjs-styleguide#style-y126) | 'ng_directive_name': 0 |
...
| ng_service_name | All your services should have a name starting the parameter you can define in your config object. The second parameter can be a Regexp. ("ng_service_name":  [2, "ng"]) [Y125](https://github.com/johnpapa/angularjs-styleguide#style-y125) | 'ng_on_watch': 2 |
