 ...
 * The second parameter can be a config object [2, {nameStyle: 'dash', typeSeparator: 'dot', ignoreTypeSuffix: true}] to match `avenger-profile.directive.js` or `avanger-api.service.js`.
 * Possible values for `typeSeparator` and `nameStyle` are `dot`, `dash` and `underscore`.
 * The options `ignoreTypeSuffix` ignores camel cased suffixes like `someController` or `myService`.
